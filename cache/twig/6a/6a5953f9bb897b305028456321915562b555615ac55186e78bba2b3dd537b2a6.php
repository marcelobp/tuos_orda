...
class __TwigTemplate_7174e4692f01337564ca2f312c48ab1f8620d4c118f40422bbf4e3335e318b1c extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        // line 13
        if ($this->getAttribute(($context["session"] ?? null), "search_by_show", array())) {
            echo twig_escape_filter($this->env, $this->getAttribute(($context["session"] ?? null), "search_by_show", array()), "html", null, true);
        } else {
            echo "All fields";
        }
        echo "</span> <span class=\"caret\"></span>
                        ...
                        <ul class=\"dropdown-menu\" id=\"search_by_menu\" role=\"menu\">
                            ...
                            <li ";
        // line 18
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "author")) {
            echo "class=\"active\"";
        }
        echo "><a href=\"#\" id=\"author\">Author</a></li>
                            <li ";
        // line 19
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "title")) {
            echo "class=\"active\"";
        }
        echo "><a href=\"#\" id=\"title\">Title</a></li>
                            <li ";
        // line 20
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "description")) {
            echo "class=\"active\"";
        }
        echo "><a href=\"#\" id=\"description\">Description</a></li>                            
                            <li ";
        // line 21
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "tag")) {
            echo "class=\"active\"";
        }
        echo "><a href=\"#\" id=\"tag\">Tag</a></li>
                            <li ";
        // line 22
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "category")) {
            echo "class=\"active\"";
        }
        echo "><a href=\"#\" id=\"category\">Category</a></li>                            
                            <li ";
        // line 23
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "extension")) {
            echo "class=\"active\"";
        }
        echo "><a href=\"#\" id=\"extension\">File extension</a></li>
                            <li ";
        // line 24
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "orcid")) {
            echo "class=\"active\"";
        }
        echo "><a href=\"#\" id=\"\">ORCID</a></li>
                            <li ";
        // line 25
        if (($this->getAttribute(($context["session"] ?? null), "search_by", array()) == "doi")) {
            echo "class=\"active\"";
        }
        ...
        if (($context["home"] ?? null)) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute(($context["session"] ?? null), "search_term", array()), "html", null, true);
        }
        echo "\">
                    <div class=\"input-group-btn\">
